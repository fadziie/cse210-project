...
{
    public Checklist (string name, string description, int points, string goalType, string complete, int maxInstances, int currentInstances, int bonus)
    ...
    public Checklist (List<string> goals) : base (goals)
    {
    }
