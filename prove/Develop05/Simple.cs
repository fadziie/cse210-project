public class Simple : Goal
{
    ...
    public Simple(List<string> goals) : base(goals)
    {
    }

    public Simple(List<string> goals, int score) : base(goals, score)
    {
    }

    public Simple(string name, string description, int points, string goalType, string complete)
